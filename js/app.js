...
tl.fromTo('#Vector_12', { y: 20, rotate: '0deg' }, { y: 0, rotate: '400deg', duration: 1, delay: 1.5 }, '<')
tl.to('#Vector_13', { scale: 0.1, x: 25, y: 26 }, '<50%')
tl.fromTo('#Vector_12', { scale: 0, x: 0, y: 0 }, { scale: 0.28, x: -45, y: 48 }, '<')
...
tl.to('.logo__more', { display: "block", ease: 'elastic.out(1, 1)' })
